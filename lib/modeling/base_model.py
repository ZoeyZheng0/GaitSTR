...
class BaseModel(MetaModel, nn.Module):
    ...
    def inputs_pretreament(self, inputs):
        ...
        seqs_batch, ori_batch, gait_batch, labs_batch, typs_batch, vies_batch, seqL_batch = inputs
        ...
        oris = np2var(np.asarray(ori_batch), requires_grad=requires_grad).float()
        ...
        return seqs_gait, seqs, oris, labs, typs, vies, seqL
    ...
    def run_train(model):
        ...
        for inputs in model.train_loader:
            ...
            if model.iteration % model.engine_cfg['save_iter'] == 0 or model.iteration == 1:
                # save the checkpoint
    ...
    def run_test(model):
        ...
        if rank == 0:
            ...
            if eval_func in ["evaluation_Gait3D", "evaluation_GREW"]:
